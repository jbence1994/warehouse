...
namespace Warehouse.Migrations
{
    ...
    [Migration("20210427092526_Add Sale And Sale Details Tables")]
    partial class AddSaleAndSaleDetailsTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Warehouse.Core.Models.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Core.Models.SaleDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Warehouse.Core.Models.TechnicianBalanceSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("technician_balance_summary");
                });
            ...
            modelBuilder.Entity("Warehouse.Core.Models.SaleDetail", b =>
                {
                    ...
                    b.HasOne("Warehouse.Core.Models.Sale", "Sale")
            ...
            modelBuilder.Entity("Warehouse.Core.Models.TechnicianBalanceSummary", b =>
                {
                    b.HasOne("Warehouse.Core.Models.Technician", "Technician")
                        .WithOne("Balance")
                        .HasForeignKey("Warehouse.Core.Models.TechnicianBalanceSummary", "TechnicianId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
